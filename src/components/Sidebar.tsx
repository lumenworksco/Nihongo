...
import { BookOpen, Layers, Zap, Home, Settings2, LogIn, LogOut, User, School, ALargeSmall, PenLine, BookOpenText, ClipboardCheck, BarChart2 } from 'lucide-react';
...
const navLinks = [
  ...
  { to: '/stats',      label: 'Progress',   icon: BarChart2,       exact: false },
];
